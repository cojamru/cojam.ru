	...
	our: [
		{
			...
			id: 'graveblood',
			platform: 'gba',
			description: 'Городские легенды говорят, что где-то здесь, в лесах Грейвблуда, есть старая проклятая библиотека. Вика и её новые друзья собираются найти это место.',
			release: 'TBD',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/graveblood.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			platform: 'flash',
			release: 2016,
			description: 'За долгое время, проведённое в уютной комнатке, ты впервые выходишь на улицу. Судьба играет тобой, и ты попадаешь в таинственную организацию, теперь на твоих плечах лежит решение многих вещей для благополучия организации. А что, если в принятии решений положиться на монетку?',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/coin.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			platform: 'flash',
			release: 2016,
			description: 'Наши герои — исследовательская группа, задача которой — замораживать соседние земли для их дальнейшего изучения и населения. Однако на пути у группы встают другие цивилизации, которым не нравится их деятельность. Один маленький конфликт превращается в большое противостояние.',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/jicem-ltz.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			platform: 'flash',
			release: 2015,
			description: 'В день, когда наша героиня выбирает обновки для своего гардероба, покой в магазине нарушают пришельцы, пришедшие на Землю, чтобы уничтожить всё нижнее бельё.',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/titties.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/lessy.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			platform: 'flash',
			release: 2015,
			description: 'Игра является концептуальной демкой игры «Jicem», разработка которой на данный момент отложена на неопределённый срок. Здесь можно поиграть в дезмач с компьютерными противниками на трёх различных уровнях.',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/jicem.png`,
				screenshots: []
			},
			links: {
...

		{
			...
			platform: 'flash',
			release: 2011,
			description: 'Простенькая игрушка про скейтбординг. Здесь было уделено много внимания кастомизации — здесь можно выбирать одежду, причёски своему скейтеру и даже изменять очертания мира прямо во время игры.',
			img: {
				icon: '',
				poster: `${INFO.CDN_paths.games.posters}/f3s.png`
			},
			links: {
