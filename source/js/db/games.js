...
export const gamesDB = {
	our: [
...

		{
			...
			contest: {
				name: 'Gamiron №11',
				link: 'https://gcup.ru/forum/83-46421-1',
			},
			platform: 'flash',
			release: 2016,
			description:
...

		{
			...
			id: 'titty',
			contest: {
				name: 'Two Weeks Game 6',
				link: 'https://twoweeksgame6.blogspot.com',
			},
			platform: 'flash',
			release: 2015,
			description:
...

		{
			...
			id: 'lessy',
			contest: {
				name: 'Two Weeks Game 5',
				link: 'https://twoweeks.github.io/games-db/?get=twg&comp=5',
			},
			platform: 'flash',
			release: 2015,
			description:
...

		{
			...
			release: 2013,
			description:
				'Твой страх, насколько сильным он может быть? Скоро ты узнаешь об этом, но это будет твоим последним уроком.',
			description_more:
